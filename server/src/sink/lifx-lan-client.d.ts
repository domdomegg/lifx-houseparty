...
declare module "lifx-lan-client" {
  ...
  class Light {
    ...
    setWaveform(hue: number, saturation: number, brightness: number, kelvin?: number, duration?: number, callback?: () => void): void;
    waveform(hue: number, saturation: number, brightness: number, kelvin?: number, transient?: boolean, period?: number, cycles?: number, skewRatio?: number, waveform?: 0 | 1 | 2 | 3 | 4, callback?: () => void): void;
